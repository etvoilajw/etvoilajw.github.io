...
Rectangle = function(x, y, w, h, color) {
  ...
  this.Draw = function(context) {
    context.fillStyle = this.color.ToStandard();
...
Animation = function(width, height, row, column, limit, imgSrc, fps, columns, rows) {
  if(fps == null || fps >= 33) {
    ...
    this.Draw = function(context) {
      ...
      context.drawImage(this.image, this.cropPosition.x, this.cropPosition.y,this.width, this.height, this.position.x, this.position.y, this.width, this.height);
